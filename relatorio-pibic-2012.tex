...
% Marcos: "algum objeto" é melhor que "algum lugar ou algo"
algum lugar ou algo. Em música pode-se visualizar o contorno de
...
% Marcos: "Além disso, contornos são importantes porque ajudam..."
O estudo de relação de contornos é importante porque contornos ajudam
...
% Marcos: dizer o nome do software e um (vide seção de materiais)
ele identificou a inconsistência do algoritmo de forma prima de Marvin
e Laprade \cite{Marvin1987}. Esta inconsistência pode implicar em
fragilidades nas ramificações desta teoria.
% Marcos: ela quem? "impacto destas inconsistências nas análises
...
\item Mendeley\footnote{Disponível em
  ...
  textos da pesquisa.
  % pode juntar com vírgula: "...da pesquisa, necessário para..."
Foi necessário para o
...
\item Github\footnote{Disponível em
  ...
  MusiContour e para organziar as tarefas diárias.
...
% Marcos: Tem muito 'mapa': mapeamento, mapa, mapa.
O Mapeamento foi feito a partir de um mapa que havia sido iniciado
pelo bolsista anterior. Este mapa estava incompleto.
% Marcos: substituir guia por campo
Haviam apenas as guias Autor, Operação e Página. Precisava ser
...
% Marcos: manter consistência da escrita: "testei os cálculos mais
% simples manualmente e usei o MusiContour para os cálculos mais
% complexos."
testei os cálculos mais simples manualmente e para os mais complexos
utilizei o MusiContour. Para utilizar o MusiContour foi necessário um
...
% Marcos: inverter. Começar com "optamos por usar o Linux/Ubuntu
% porque..."
O MusiCountour não havia sido testado no windows, sistema que eu
utilizava, e não tinhamos tempo para testá-lo, então optamos por
utilizar o Linux/Ubuntu.  Esta escolha foi bem sucedida, pois apreder
% Marcos: "mais prático que testar no Windows"
a utilizar o software foi mais prático.
...
consultas rápidas de
% Marcos: tirar "uma determinada"
uma determinada operação de contorno (vide seção de discussão).
...
% Marcos: O problema é agrupar ferramentas de importância diferente em
% um só item. você tem pelo menos 3 itens: musicontour; python;
% linux/ubuntu e latex/kile
...
% Marcos: "tem os campos"
está subdividido em: Artigo, tipo de operação, página, obra,
...
para economizar tempo e enrgia.
% Este período é desnecessário.
Por exemplo, o MusiContour realiza cálculos extensos e difíceis.
Calcular redução de contornos ou
comparação difusa de contornos, além de ser trabalhoso é demorado,
isso sem contar que durante os cáculos podemos confundir algum número
ou sinal e gerar
% Marcos: basta dizer que gera erros. mostrar o processo é mais
% eficiente do que dizer o tamanho dele.
um problema muito maior. O MusiContour resolve tudo com a agilidade de
uma calculadora economizando tempo e energia.
...
subtração. Se o valor da linha for maior que o valor da conluna
